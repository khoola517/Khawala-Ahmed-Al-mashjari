...
import 'package:finallproject/core/view/splashscreen.dart';
import 'package:finallproject/core/view/vaccine_screen.dart';

import 'package:finallproject/local_controller/local.dart';
    ...
    return  GetMaterialApp(
      ...
      theme:ThemeData(
        textTheme: const TextTheme(
         ...
         //bodyLarge: TextStyle(height: 4,fontSize: 17,fontWeight: FontWeight.bold),
        ),
      ...
      body: SafeArea(
        child: Column(
          ...
          const SizedBox(height: 130,),
            Image.asset("images/tow.png",height: 180,width: 160,fit: BoxFit.fill,),
            ...
            Text("32".tr,textAlign: TextAlign.center,style:const TextStyle(fontSize:20),),
            ...
            TextButton.icon(
              ...
              icon: Text("35".tr,style:const TextStyle(fontSize:18),),
              label: const Icon(
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            const Text(
              'You have pushed the button this many times:123456789',
            ),
            Text(
              '$_counter',
